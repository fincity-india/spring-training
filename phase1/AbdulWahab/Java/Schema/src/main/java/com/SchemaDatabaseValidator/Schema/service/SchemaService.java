...
public class SchemaService {
	...
	public JsonNode getSchemaMongo(String id) throws Exception {
        ...
        Schema schemaDoc = mongoTemplate.findAndModify(query, update, Schema.class, collectionName);
...
//		
		...
		Schema schema1 = schemaRepo.findById(_id)
                .orElseThrow(() -> new SchemaNotFoundException("User not found"));

        schema1.setSchemaName(schema.getSchemaName());
        schema1.setSchema(schema.getSchema());
