            ...
            if (schema.has("properties")) {
                ...
                properties.fields().forEachRemaining(entry -> {
                    ...
                    if (jsonData.has(fieldName)) {
                        ...
                        if (fieldSchema.has("maximum") && fieldValue.isInt()) {
                        ...
                        if (fieldSchema.has("format") && fieldSchema.get("format").asText().equals("email")) {
                            String email = fieldValue.asText();
                            if (!email.matches("^(.+)@(.+)$")) {
                                errors.add("Field '" + fieldName + "' should be a valid email.");
                            }
                        }
                    }
                });
