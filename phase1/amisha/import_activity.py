...
def ActivityImporter(csv_file_path,table_name,engine):
...
# You can customize the columns as needed
  ...
  for col_name in sample_chunk.columns:
    ...
    if col_name == 'created_at_epoch' or col_name == 'updated_at_epoch':
...
# Load CSV in chunks and insert into the MySQL table
  ...
  print("Finished loading the activity CSV file into the MySQL database.")
